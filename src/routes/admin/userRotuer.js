...
router.post('/updateUser/:id',authenticateJWT, multipartMiddleware, usersController.updateUser);
router.post('/deleteUser/:id',authenticateJWT, usersController.deleteUser);
router.post('/updateUserStatus/:id',authenticateJWT, usersController.updateUserStatus);
